                ...
                <template #body="{
                    ...
                    <template v-else>
                        <template v-for="record in available.records">
                            <div class="w-full p-4 border rounded-md transition-all hover:bg-fashion-surface [&>*]:border-0 mb-4 last:mb-0">
                                <a :href="record.actions[0].url">
                                    <div class="flex justify-between">
                                        <div class="text-sm font-semibold">
                                            @lang('shop::app.customers.account.orders.order-id'): #@{{ record.id }}

                                            <p class="text-xs font-normal text-fashion-muted">
                                                @{{ record.created_at }}
                                            </p>
                                        </div>
                                    ...
                                    <div class="mt-2.5 text-xs font-normal text-fashion-muted">
