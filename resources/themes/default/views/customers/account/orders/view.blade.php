<x-shop::layouts.account>
    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
            ...
            <div class="flex gap-1.5">
                ...
                @if (
                    ...
                    <a
                        ...
                        class="secondary-button border-fashion-border px-5 py-3 font-normal max-md:hidden"
                    >
        ...
        <div class="mt-8 max-md:mt-5 max-md:grid max-md:gap-4">
            <x-shop::tabs>
                ...
                >
                    ...
                    >
                        ...
                        <div class="relative mt-8 overflow-x-auto rounded-xl border">
                            <table class="w-full text-left">
                                <thead class="border-b border-fashion-border bg-fashion-surface text-sm text-black">
                                                        ...
                                                        @foreach ($item->additional['attributes'] as $attribute)
                                                            ...
                                                            @else
                                                                ...
                                                                <a
                                                                    ...
                                                                    class="text-fashion-accent hover:underline"
                    ...
                    <div class="grid gap-4 md:hidden">
                        ...
                        <div class="rounded-lg border">
                            ...
                            <div class="flex w-full justify-center rounded-b-lg border-t text-center">
                                ...
                                @if ($order->canCancel())
                                    ...
                                    <!-- Seperator -->
                                    <span class="my-auto h-5 w-0.5 bg-fashion-border py-3"></span>

                                    <a
                                        href="javascript:void(0);"
                                        class="mx-auto w-full py-3 text-sm font-medium hover:bg-fashion-surface max-sm:py-2"
                                        @click="$emitter.emit('open-confirm-modal', {
                                            message: '@lang('shop::app.customers.account.orders.view.cancel-confirm-msg')',
                                ...
                                @include('shop::customers.account.eu-withdrawals.button', [
                                    'order' => $order,
                                    'variant' => 'mx-auto w-full py-3 text-sm font-medium text-fashion-navy hover:bg-fashion-surface max-sm:py-2',
                                ])
                            </div>
                        </div>
                        ...
                        <x-shop::accordion
                            :is-active="true"
                            class="overflow-hidden rounded-lg !border-none !bg-fashion-surface"
                        >
                            <x-slot:header class="bg-fashion-surface !px-4 py-3 text-sm font-medium max-sm:py-2">
                               @lang('shop::app.customers.account.orders.view.item-ordered')
                            </x-slot>

                            <x-slot:content class="grid gap-2.5 !bg-fashion-surface !p-0">
                                @foreach ($order->items as $item)
                        ...
                        <!--Summary -->
                        <div
                            class="w-full rounded-md bg-fashion-surface"
                            v-pre
                        >
                            ...
                            @foreach ($order->invoices as $invoice)
                                ...
                                <div class="grid gap-4 md:hidden">
                                    ...
                                    <x-shop::accordion
                                        ...
                                        class="overflow-hidden rounded-lg !border-none !bg-fashion-surface"
                                    >
                                        <x-slot:header class="!mb-0 rounded-t-md bg-fashion-surface !px-4 py-3 text-sm font-medium max-sm:py-2">
            ...
            <div
                class="w-full rounded-md bg-fashion-surface md:hidden"
                v-pre
            >
                <div class="rounded-t-md border-none !px-4 py-3 text-sm font-medium max-sm:py-2">
                ...
                <div class="grid gap-1.5 rounded-md rounded-t-none border border-t-0 bg-white px-4 py-3 text-xs font-medium">
                    ...
                    @if ($order->shipping_address)
                        <div class="text-sm font-medium text-fashion-muted">
            ...
            <!-- Desktop View -->
            <div
                class="mt-11 flex flex-wrap justify-between gap-x-11 gap-y-8 border-t border-fashion-border pt-7 max-md:hidden"
                v-pre
            >
                <!-- Billing Address -->
                @if ($order->billing_address)
                    <div class="grid max-w-[200px] gap-4 max-868:w-full max-868:max-w-full max-md:max-w-full max-md:gap-2">
                        <p class="text-base text-fashion-muted max-md:text-lg max-md:text-black">
                            @lang('shop::app.customers.account.orders.view.billing-address')
                        </p>
