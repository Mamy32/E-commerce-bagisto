...
>
    ...
    <div class="container mt-20 max-1180:px-5 max-md:mt-12">
        ...
        <div class="m-auto w-full max-w-[870px] rounded-xl border border-fashion-border p-16 px-[90px] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0">
            ...
            <p class="mt-4 text-xl text-fashion-muted max-sm:mt-0 max-sm:text-sm">
                ...
                <x-shop::form :action="route('shop.customers.register.store')">
                    ...
                    @if (core()->getConfigData('customer.settings.create_new_account_options.news_letter'))
                        <div class="mb-5 flex select-none items-center gap-1.5">
                            ...
                            <label
                                class="cursor-pointer select-none text-base text-fashion-muted max-sm:text-sm ltr:pl-0 rtl:pr-0"
                                for="is-subscribed"
                            >
                    ...
                    @if(
                        ...
                        <div class="mb-2 flex select-none items-center gap-1.5">
                            ...
                            <label
                                class="cursor-pointer select-none text-base text-fashion-muted max-sm:text-sm"
                                for="agreement"
                                v-pre
                            >
                            ...
                            @if (core()->getConfigData('general.gdpr.agreement.agreement_content'))
                                <span
                                    class="cursor-pointer text-base text-fashion-navy max-sm:text-sm"
            ...
            <p class="mt-5 font-medium text-fashion-muted max-sm:text-center max-sm:text-sm">
                @lang('shop::app.customers.signup-form.account-exists')

                <a class="text-fashion-navy"
