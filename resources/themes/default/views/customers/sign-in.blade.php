                ...
                <x-shop::form :action="route('shop.customer.session.create')">
                    ...
                    <div class="flex justify-between">
                        <div class="flex select-none items-center gap-1.5">
                            ...
                            <label
                                class="icon-uncheck peer-checked:icon-check-box cursor-pointer text-2xl text-fashion-navy peer-checked:text-fashion-navy max-sm:text-xl"
                                for="show-password"
                            ></label>
