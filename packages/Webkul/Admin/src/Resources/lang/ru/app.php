                ...
                'types' => [
                    ...
                    'configurable' => [
                        ...
                        'mass-edit' => [
                            ...
                            'edit-special-price' => 'Редактировать специальную цену',
        ...
        'index' => [
            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'whatsapp' => [
                        'title' => 'Плавающая кнопка WhatsApp',
                        'info' => 'Показывать плавающую кнопку связи через WhatsApp на каждой странице магазина.',
                        'enable' => 'Включить плавающую кнопку WhatsApp',
                        'number' => 'Номер WhatsApp',
                        'number-info' => 'Укажите код страны, только цифры, без пробелов и символов (напр. 6281234567890).',
                        'message' => 'Предзаполненное сообщение',
                    ],
