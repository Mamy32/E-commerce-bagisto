            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                trackers.forEach(async (tracker) => {
                    ...
                    try {
                        ...
                        // Display live map link if it's an instant courier
                        ...
                        // Render timeline for regular couriers
                        ...
                        // Sort history by updated_at descending (newest first)
                        ...
                        history.forEach((item, index) => {
                            ...
                            // Make the newest event a little more prominent
