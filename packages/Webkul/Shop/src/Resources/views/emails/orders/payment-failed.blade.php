@component('shop::emails.layout')
    <div style="margin-bottom: 34px;">
        <span style="font-size: 22px;font-weight: 600;color: #D32F2F">
            Payment Failed
        </span> <br>
        ...
        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            We're sorry to inform you that your payment for order <a href="{{ route('shop.customers.account.orders.view', $order->id) }}" style="color: #2969FF;">#{{ $order->increment_id }}</a> has failed.
