@component('shop::emails.layout')
    <div style="margin-bottom: 34px;">
        <span style="font-size: 22px;font-weight: 600;color: #F59E0B">
            Payment Pending
        </span> <br>
        ...
        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            Your order <a href="{{ route('shop.customers.account.orders.view', $order->id) }}" style="color: #2969FF;">#{{ $order->increment_id }}</a> is currently pending payment.
            If you have already made the payment, please allow some time for it to be processed.
        </p>
    </div>
