@component('shop::emails.layout')
    <div style="margin-bottom: 34px;">
        <span style="font-size: 22px;font-weight: 600;color: #10B981">
            Order Delivered
        </span> <br>
        ...
        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            Good news! Your order <a href="{{ route('shop.customers.account.orders.view', $shipment->order->id) }}" style="color: #2969FF;">#{{ $shipment->order->increment_id }}</a> has been successfully delivered.
